...
class FibMatrix(
    ...
    override fun times(other: FibMatrix) = FibMatrix(characteristic + other.characteristic)

    override fun unaryDiv() = FibMatrix(-characteristic)

    override fun times(other: Rational) = TODO("Think through")

    override fun div(other: FibMatrix) = FibMatrix(characteristic - other.characteristic)
    ...
    companion object {
        ...
        private tailrec fun nextFib(
            n: Long,
            m: Holder<Rational, Rational>
