...
>(
    ...
    override fun compareTo(other: Units<S, K, *, *>) = basis.compareTo(other.basis)
...
>(
    ...
    override fun compareTo(other: Measure<S, K, *, *>) = quantity.compareTo((other into unit).quantity)
