...
fun main(args: Array<String>): Unit = exitProcess(CommandLine(LoggingDemo()).execute(*args))
...
fun fail(thing: String): String = throw BusinessException("This is not the right thing: $thing")

fun error(thing: String): String = throw IndexOutOfBoundsException("Write the code for $thing")
